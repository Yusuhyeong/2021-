...
public class Weathers extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button tomenu = (Button) findViewById(R.id.menu);
        ...
        gpsTracker = new GpsTracker(Weathers.this);
        ...
        */
        ...
        tomenu.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent registerIntent = new Intent(Weathers.this, MenuActivity.class);
                Weathers.this.startActivity(registerIntent);
            }
        });
        ...
        reverseGeoCoder = new MapReverseGeoCoder("b745f2abe75d96c02303a87d13413663", MapPoint.mapPointWithGeoCoord(latitude, longitude), new MapReverseGeoCoder.ReverseGeoCodingResultListener() {
            ...
            public void onReverseGeoCoderFailedToFindAddress(MapReverseGeoCoder mapReverseGeoCoder) {
                Toast.makeText(Weathers.this, "위치 정보 확인 불가, 네트워크를 확인해 주세요", Toast.LENGTH_SHORT).show();
            }
    ...
    */
        ...
        for(int i=0; i<14; i++){
            ...
            if(SKY[i].equals("1")) sky_img[i].setImageResource(R.drawable.sn);
            else if(SKY[i].equals("3")) sky_img[i].setImageResource(R.drawable.snc);
            else if(SKY[i].equals("4")) sky_img[i].setImageResource(R.drawable.cd);
